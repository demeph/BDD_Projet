...
\begin{document}
	...
	\section{Algo de Bernstein}
		...
		\newpage
				...
				\begin{figure}[!h]		
					\centering
					{\includegraphics[height=17cm]{picture/decomp1.png}}
				...
				\begin{figure}[!h]		
					\centering
					{\includegraphics[height=8cm]{picture/decomp2.png}}
		...
		\section{Conclusion préliminaire}
			...
			\section{Annexe}
				...
				\begin{figure}[!h]
					\centering						
					\rotatebox{90}{\includegraphics[height=8cm]{picture/graphe_dependances.png}}
