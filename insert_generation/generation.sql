INSERT INTO Film Values (1, 'xXx' : Reactivated, 19/01/17, 'Tout public', 110, 1, 'oui');
INSERT INTO Film Values (2, 'Assassin''s Creeds', 21/12/16, -12, 140, 2, 'oui');
INSERT INTO Film Values (3, 'Lalaland', 25/01/17, 'Tout public', 125, 3, 'non');
INSERT INTO Cinema Values (1, 'St-Herblain', 'Place jean-bart', 'UGC', 10);
INSERT INTO Cinema Values (2, 'St-Herblain', 'Allee la perouse', 'Pathé Gaumont', 12);
INSERT INTO Cinema Values (3, 'Nantes', 12 Place du commerce, 'Pathé Gaumont', 8);
INSERT INTO Cinema Values (4, 'Angers', 1ere avenue des droits de l''homme, 'Pathé Gaumont', 5);
...
INSERT INTO Seance Values (1, 1, 1, 20h, 24/01/17, 7, 'oui');
INSERT INTO Seance Values (2, 2, 1, 16h30, 27/01/17, 11, 'Non');
INSERT INTO Seance Values (3, 3, 2, 11h00, 10/01/17, 1, 'Non');
INSERT INTO Seance Values (4, 4, 3, 22h, 10/01/17, 3, 'Non');
...
INSERT INTO Salle Values (1, 7, 'oui', 3, 100, 0);
INSERT INTO Salle Values (2, 11, 'oui', 5, 255, 10);
INSERT INTO Salle Values (3, 1, 'non', 10, 345, 10);
INSERT INTO Salle Values (4, 3, 'non', 3, 75, 3);
